                ...
                elseif (isset($_POST['newUser'])) {
                    ...
                    <body>
                        <section class="container login-form">
                            ...
                            <div class="form-group">
                                <b>Role de l'employé :</b>
                                <SELECT name="role" size="1">
                                    <option valeur="Preparateur" selected>Préparateur</option>
